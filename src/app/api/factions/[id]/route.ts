...
// GET: Fetch details for a single faction
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
    try {
        ...
        // If the requester is the owner, also fetch applications
...
// POST: Join a faction or apply to it
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
    try {
        ...
        } else { // recruitmentMode is 'application'
...
// PATCH: Manage faction members and settings
...
// DELETE: Leave or Disband a faction
export async function DELETE(req: NextRequest, { params }: { params: { id: string } }) {
    try {
        ...
        if (isOwner) {
            // Owner is deleting (disbanding) the faction
            ...
            membersSnap.docs.forEach(doc => {
                ...
                batch.delete(doc.ref); // Delete member from subcollection
            });
            ...
            // Delete the faction document itself
